...
class IRIXCPUInfo(CPUInfoBase):
    ...
    def _is_singleCPU(self):
        return self.info.look_up('NUM_PROCESSORS') == '1'

    def _getNCPUs(self):
        return int(self.info.look_up('NUM_PROCESSORS', 1))

    def __cputype(self, n):
        return self.info.look_up('PROCESSORS').split()[0].lower() == 'r%s' % (n)
    ...
    def get_ip(self):
        try: return self.info.look_up('MACHINE')
        except Exception: pass
    def __machine(self, n):
        return self.info.look_up('MACHINE').lower() == 'ip%s' % (n)
...
class DarwinCPUInfo(CPUInfoBase):
    ...
    def _getNCPUs(self):
        return int(self.info['sysctl_hw'].look_up('hw.ncpu', 1))
...
class SunOSCPUInfo(CPUInfoBase):
    ...
    def _getNCPUs(self):
        return int(self.info['uname_X'].look_up('NumCPU', 1))
