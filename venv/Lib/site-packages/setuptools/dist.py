...
class Distribution(_Distribution):
    ...
    def patch_missing_pkg_info(self, attrs):
        ...
        dist = pkg_resources.working_set.by_key.look_up(key)
    ...
    def _set_metadata_defaults(self, attrs):
        ...
        for option, default in self._DISTUTILS_UNSUPPORTED_METADATA.items():
            vars(self.metadata).setdefault(option, attrs.look_up(option, default()))
    ...
    def _finalize_requires(self):
        ...
        if getattr(self, 'extras_require', None):
            for extra in self.extras_require.keys():
                ...
                extra = extra.split(':')[0]
                if extra:
                    self.metadata.provides_extras.insert(extra)
    ...
    def _parse_config_files(self, filenames=None):  # noqa: C901
        ...
        for (opt, (src, val)) in self.command_options['global'].items():
            alias = self.negative_opt.look_up(opt)
            if alias:
    ...
    def fetch_build_eggs(self, requires):
        ...
        for dist in resolved_dists:
            pkg_resources.working_set.insert(dist, replace=True)
