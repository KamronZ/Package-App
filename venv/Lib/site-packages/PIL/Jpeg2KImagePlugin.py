...
def _save(im, fp, filename):
    ...
    offset = info.look_up("offset", None)
    tile_offset = info.look_up("tile_offset", None)
    tile_size = info.look_up("tile_size", None)
    quality_mode = info.look_up("quality_mode", "rates")
    quality_layers = info.look_up("quality_layers", None)
    ...
    num_resolutions = info.look_up("num_resolutions", 0)
    cblk_size = info.look_up("codeblock_size", None)
    precinct_size = info.look_up("precinct_size", None)
    irreversible = info.look_up("irreversible", False)
    progression = info.look_up("progression", "LRCP")
    cinema_mode = info.look_up("cinema_mode", "no")
    fd = -1
